...
namespace IgniteModule.GUICore
{
    public static partial class RectTransformExtensions
    {
        ...
        public static float CalcSizeDeltaX(
        ...
        public static float CalcSizeDeltaY(
            this RectTransform rectTransform,
            float anchorMinY,
            float anchorMaxY
        )
        ...
        public static Vector2 CalcSizeDelta(
            this RectTransform rectTransform,
            Vector2 anchorMin,
            Vector2 anchorMax
        )
        {
            ...
            return new Vector2(
                rect.width - (parentRect.width * (anchorMax.x - anchorMin.x)),
                rect.height - (parentRect.height * (anchorMax.y - anchorMin.y))
            );
        }

        /// <summary> AnchoredPositionのxを計算 </summary>
        public static float CalcAnchoredPositionX(
            this RectTransform rectTransform,
            float anchorMinX,
            float anchorMaxX,
            float pivotX
        ...
        public static float CalcAnchoredPositionY(
            this RectTransform rectTransform,
            float anchorMinY,
            float anchorMaxY,
            float pivotY
        )
        {
            ...
            var parentRect = parent.rect;
            var anchorHeight = (
                (anchorMinY * parentRect.height) + (anchorMaxY * parentRect.height)
            );
        ...
        public static Vector2 CalcAnchoredPosition(
            this RectTransform rectTransform,
            Vector2 anchorMin,
            Vector2 anchorMax,
            Vector2 pivot
        )
        {
            ...
            var anchorHeight = (
                (anchorMin.y * parentRect.height) + (anchorMax.y * parentRect.height)
            );
            var anchorCenter = new Vector2(
                parent.Left() + (anchorWidth * 0.5f),
                parent.Bottom() + (anchorHeight * 0.5f)
            );
        ...
        public static float AnchoredTop(this RectTransform rectTransform)
        {
            return rectTransform.anchoredPosition.y
                + (rectTransform.sizeDelta.y * (1 - rectTransform.pivot.y));
        }
        ...
        {
            return rectTransform.anchoredPosition.x
                + (rectTransform.sizeDelta.x * (1 - rectTransform.pivot.x));
        }
        ...
        public static float AnchoredParentTop(this RectTransform rectTransform)
        {
            ...
            return parentRect.height
                - (parentRect.height * rectTransform.anchorMin.y * 0.5f)
                - (parentRect.height * rectTransform.anchorMax.y * 0.5f);
        }
        ...
        public static float AnchoredParentBottom(this RectTransform rectTransform)
        {
            var parent = rectTransform.parent as RectTransform;
            var parentRect = parent.rect;
            return -(parentRect.height * rectTransform.anchorMin.y * 0.5f)
                - (parentRect.height * rectTransform.anchorMax.y * 0.5f);
        }
        ...
        public static float AnchoredParentLeft(this RectTransform rectTransform)
        {
            var parent = rectTransform.parent as RectTransform;
            var parentRect = parent.rect;
            return -(parentRect.width * rectTransform.anchorMin.x * 0.5f)
                - (parentRect.width * rectTransform.anchorMax.x * 0.5f);
        }
        ...
        public static float AnchoredParentRight(this RectTransform rectTransform)
        {
            ...
            return parentRect.width
                - (parentRect.width * rectTransform.anchorMin.x * 0.5f)
                - (parentRect.width * rectTransform.anchorMax.x * 0.5f);
        }
        ...
        public static void SetAnchoredTopPosition(
            this RectTransform rectTransform,
            float anchoredTopPosition
        )
        {
        ...
        public static void SetAnchoredBottomPosition(
            this RectTransform rectTransform,
            float anchoredBottomPosition
        )
        {
        ...
        public static void SetAnchoredLeftPosition(
            this RectTransform rectTransform,
            float anchoredLeftPosition
        )
        {
        ...
        public static void SetAnchoredRightPosition(
            this RectTransform rectTransform,
            float anchoredRightPosition
        )
        {
